 ...
 */
public class HTML5ResponsivePicture extends WebMarkupContainer {

    private static final long serialVersionUID = 1L;

    private RepeatingView repeatingView;

    public HTML5ResponsivePicture(String id) {
	super(id);
	add(repeatingView = new RepeatingView("sources"));
    }

    public HTML5ResponsivePicture(String id, IModel<?> model) {
	super(id, model);
    }
