...
/**
 * A subclass of {@link Image} that always adds random noise to the url every request to prevent the browser from caching the image.
 * 
...
public class NonCachingImage extends Image {
	 ...
	 */
	public NonCachingImage(String id, ResourceReference resourceReference, PageParameters resourceParameters) {
		super(id, resourceParameters, resourceReference);
	}
