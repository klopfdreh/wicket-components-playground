...
public class OutputField<T> extends FormComponent<T>
{
	...
	private String formInputScript;
	...
	/**
	 * Gets the input script of the output field applied to the form
	 * 
	 * @return the input script of the output field
	 */
	public String getFormInputScript()
	{
		...
		return String.format(formInputScript, markupIds.toArray());
	}

	/**
	 * Sets the input script of the output field applied to the form
	 * 
	 * @param formInputScript
	 *            the input script of the output field
	 */
	public void setFormInputScript(String formInputScript)
	{
		// Assign the calculated value of the input script to the output field
		this.formInputScript = "%s.value=" + formInputScript;
	}
	...
	public void renderHead(IHeaderResponse response)
	{
		...
		if(getFormInputScript() != null){			
			response.render(OnDomReadyHeaderItem.forScript(String.format(
				"$('#%s').on('input', function() { %s });", form.getMarkupId(), getFormInputScript())));
		}
	}
