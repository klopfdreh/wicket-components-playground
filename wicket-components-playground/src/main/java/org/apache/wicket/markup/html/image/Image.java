...
public class Image extends WebComponent implements IResourceListener {
     ...
     * {@link #getImageResourceReference()} or {@link #getImageResource()}
     * 
     * @param id
     */
     ...
     */
    public Image(final String id, final ResourceReference resourceReference, final ResourceReference... resourceReferences) {
    ...
    /**
     * Adding an image to {@link org.apache.wicket.ajax.AjaxRequestTarget} most
     * of the times mean that the image has changes and must be re-rendered.
     * <p>
     * With this method the user may change this default behavior for some of
     * her images.
     * </p>
     * 
     * @return {@code true} to add the anti cache request parameter,
    ...
    /**
     * Adds random noise to the url every request to prevent the browser from
     * caching the image.
     * 
     * @param tag
     */
